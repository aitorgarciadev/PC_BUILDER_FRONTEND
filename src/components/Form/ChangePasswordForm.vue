...
async function setNewPassword() {
  const response = await auth.setNewPassword(
  ...
  else textAlert.value = "Error changed password";
...
<template>
  <form
    class="w-full max-w-2xl px-4 py-8 mx-auto"
    ...
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div
          v-if="textAlert != ''"
          :class="
            textAlert == 'Password successfully changed.'
              ? 'bg-green-500'
              : 'bg-red-500'
          "
