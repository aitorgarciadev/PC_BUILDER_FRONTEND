...
<template>
  <Menu as="div" class="relative inline-block text-left">
    <div>
      <MenuButton
        class="inline-flex w-full justify-center items-center gap-x-1.5 rounded-md bg-transparent border-2 border-white hover:border-gray-300 px-2 py-1 text-sm font-semibold text-gray-900"
      >
        <img
        ...
        />
        <ChevronDownIcon
          class="-mr-1 h-5 w-5 text-white hover:text-gray-300"
          aria-hidden="true"
        />
      </MenuButton>
    </div>
