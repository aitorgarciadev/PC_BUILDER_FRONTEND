<template>
  <div
    class="flex h-screen justify-center items-center backdrop-blur-sm bg-white/30"
  >
    <div
    ...
    >
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p class="text-sm text-center mt-10 text-gray-400">
          ——— Connect With ———
        </p>
        ...
        <div class="text-sm text-center mt-10">
          <a
            href="#"
            class="font-semibold text-blueFunko-700 hover:text-blueFunko-600"
            >Forgot password?</a
          >
        </div>
